# Financial Modeling Prep – Documentazione API

Sorgente: https://site.financialmodelingprep.com/developer/docs

Endpoint totali estratti: **263**


## Autorizzazione

Tutte le richieste devono essere autorizzate via API key.
- Header: `apikey: YOUR_API_KEY`
- Query string: `?apikey=YOUR_API_KEY` (oppure `&apikey=` se già presenti altri parametri)
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/search-symbol
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/search-name
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/search-cik
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/search-cusip
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/search-isin
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/search-company-screener
...
Example Building a Watchlist: An investor interested in technology stocks with a market cap of over $10 billion can use the Stock Screener API to filter and create a watchlist of potential investment opportunities. The investor can further refine the list based on other criteria such as beta and trading volume.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/search-exchange-variants
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/company-symbols-list
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/financial-symbols-list
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/cik-list
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/symbol-changes-list
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/etfs-list
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/actively-trading-list
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/earnings-transcript-list
...
Example Use Case An investor looking to analyze a company’s earnings performance over several quarters can use the Earnings Transcript List API to identify companies with multiple earnings call transcripts and retrieve the necessary documents for deeper financial analysis.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/available-exchanges
...
Example Use Case A financial analyst can use the Available Exchanges API to create a customized dashboard that filters stock price data by different exchanges, ensuring they track securities relevant to specific markets.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/available-sectors
...
Example Use Case An investment firm could use the Available Sectors API to filter and analyze companies solely within the Technology sector, enabling them to track growth trends or potential opportunities in that market segment.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/available-industries
...
Example Use Case A financial analyst could use the Available Industries API to filter out companies within the Steel industry, enabling them to perform a more granular analysis of competitors and market trends within that industry.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/available-countries
...
Example Use Case An investor could use the Available Countries API to focus on companies traded in the United Kingdom, enabling a detailed analysis of UK-listed securities for international investment opportunities.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/profile-symbol
...
Example Use Case An investor researching potential tech investments can use the Company Profile Data API to review the current financial health of Apple Inc., assess its performance, and explore key metrics like its stock range and market cap to inform buying or selling decisions.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/profile-cik
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/company-notes
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/peers
...
Example Use Case Performance Benchmarking: An investor might use the Stock Peer Comparison API to compare the revenue growth and earnings per share (EPS) of a technology company to those of its peers within the same sector. This can help the investor determine whether the company is a leader in its field or if it lags behind its competitors.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/delisted-companies
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/employee-count
...
Example Use Case An equity analyst can use the Company Employee Count API to assess workforce growth at Apple Inc. over the years, comparing it to changes in the company’s revenue and profitability.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/historical-employee-count
...
Example Use Case A financial analyst can use the Company Historical Employee Count API to compare the employee count of Apple Inc. over a five-year period to evaluate how workforce changes correlate with revenue growth and market expansion.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/market-cap
...
Example Use Case An investor tracking Apple Inc.'s market performance can use the Company Market Capitalization API to retrieve the company's market cap on specific dates, helping them understand Apple's valuation trends and compare it with competitors.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/batch-market-cap
...
Example Use Case An analyst researching tech giants can use the Batch Market Capitalization API to retrieve market cap data for Apple, Microsoft, and Google in one request. This allows them to quickly compare these companies' market sizes and assess their positions within the industry.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/historical-market-cap
...
Example Use Case An investor looking to evaluate Apple's historical performance can use the Historical Market Capitalization API to retrieve past market cap data. This helps them understand how Apple's valuation has changed over time, identifying periods of growth or decline and comparing it with overall market conditions.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/shares-float
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/all-shares-float
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/latest-mergers-acquisitions
...
Example Use Case An investment analyst can use the Latest Mergers and Acquisitions API to track recent acquisitions and evaluate the impact of these deals on the companies involved. The data can be used to assess market consolidation, competitive dynamics, and potential investment opportunities.
...
- Filing Informatio n: Access official filings and documents from the SEC for a deeper analysis of the deal.
...
"link"
:
"https://www.sec.gov/Archives/edgar/data/1362468/000114036126011799/ny20065073x3_s4.htm"
}
]
```
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/search-mergers-acquisitions
...
Example Use Case A corporate strategist can use the Search Mergers and Acquisitions API to identify past acquisition targets of a competitor. This information can help shape competitive strategies or identify industry trends that may affect future business opportunities.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/company-executives
...
Example Use Case An investor looking to assess the leadership of a company before making a large investment can use the Company Executives API to review the backgrounds and compensation of top executives, providing insight into how leadership may impact company performance.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/executive-compensation
...
Example Use Case A compensation analyst can use the Executive Compensation API to compare CEO pay across different companies, analyzing how various forms of compensation—such as salary, stock awards, and performance incentives—impact executive behavior and company performance.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/executive-compensation-benchmark
...
Example Use Case An HR professional can use the Executive Compensation Benchmark API to compare the average pay for executives in the technology sector against those in the consumer goods sector, helping to determine competitive salary packages for their company's leadership team.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/quote
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/quote-short
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/aftermarket-trade
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/aftermarket-quote
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/quote-change
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/batch-quote
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/batch-quote-short
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/batch-aftermarket-trade
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/batch-aftermarket-quote
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/full-exchange-quotes
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/full-mutualfund-quotes
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/full-etf-quotes
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/full-commodities-quotes
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/full-cryptocurrency-quotes
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/full-forex-quotes
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/full-index-quotes
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/income-statement
...
Example Financial Ratio Calculation : An investor can use the Income Statements API to calculate key financial ratios, such as the price-to-earnings ratio (P/E ratio) and gross margin. These ratios help investors assess a company's valuation and profitability, enabling more informed investment decisions.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/balance-sheet-statement
...
Example Use Case An investor analyzing a potential stock purchase uses the Balance Sheet Data API to evaluate the company's assets and liabilities. They review how much cash the company has on hand, its debt obligations, and total equity to ensure the company is financially stable.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/cashflow-statement
...
Example Use Case A financial analyst uses the Cash Flow Statements API to evaluate a company's operating cash flow and free cash flow, helping to assess whether the company can sustain operations, invest in growth, and return value to shareholders.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/latest-financial-statements
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/income-statements-ttm
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/balance-sheet-statements-ttm
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/cashflow-statements-ttm
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/key-metrics
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/metrics-ratios
...
Example Use Case A portfolio manager can use the Financial Ratios API to compare liquidity ratios between companies in the same industry, helping them identify firms with stronger financial stability and more efficient operations.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/key-metrics-ttm
...
Example Use Case An analyst can use the TTM Key Metrics API to compare the free cash flow yield of several companies within the same industry, helping them make better-informed investment decisions.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/metrics-ratios-ttm
...
Example Use Case An investor uses the TTM Ratios API to analyze Apple’s liquidity and profitability ratios, helping them decide whether to invest in the company based on its trailing twelve-month financial performance.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/financial-scores
...
Example Use Case A financial analyst uses the Financial Health Scores API to check Apple’s Altman Z-Score and Piotroski Score before recommending it as a stable investment to clients.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/owner-earnings
...
Example Use Case An investor uses the Owner Earnings API to evaluate Apple’s true cash earnings before purchasing additional shares, ensuring that the company’s income aligns with their long-term investment strategy.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/enterprise-values
...
Example Use Case A financial analyst uses the Enterprise Values API to assess Apple’s total market value, factoring in debt and subtracting cash reserves, to determine whether it’s a good acquisition target.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/income-statement-growth
...
Example Use Case A financial analyst can use the Income Statement Growth API to evaluate Apple’s revenue and net income trends over the past few years, identifying whether the company is experiencing consistent growth or declines in profitability.
...
0.033599670086086914
,
"growthOtherAdjustmentsToNetIncome"
:
0
,
"growthNetIncomeDeductions"
:
0
}
]
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/balance-sheet-statement-growth
...
Example Use Case An investor can use the Balance Sheet Statement Growth API to analyze how Apple’s cash reserves and debt levels have changed over the past year, helping them assess the company’s liquidity and financial health.
...
0
,
"growthAccruedExpenses"
:
0
,
"growthCapitalLeaseObligationsCurrent"
:
0.03619047619047619
,
"growthAdditionalPaidInCapital"
:
0
,
"growthTreasuryStock"
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/cashflow-statement-growth
...
Example Investor Analysis : An investor might use the Cashflow Growth API to assess a manufacturing company’s financial health by examining its cash flow growth over the past five years. If the company shows consistent positive growth, the investor may decide to increase their investment in the company.
...
0.092615279562982
,
"growthNetDebtIssuance"
:
0.3942026057973942
,
"growthLongTermNetDebtIssuance"
:
-
0.6812426135404356
,
"growthShortTermNetDebtIssuance"
:
1.995475113122172
,
...
0.2243584784010316
,
"growthPreferredDividendsPaid"
:
-
0.013910149750415973
,
"growthIncomeTaxesPaid"
:
0.3973981476524439
,
"growthInterestPaid"
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/financial-statement-growth
...
Example Use Case An investor can use the Financial Statement Growth API to analyze Apple’s revenue, net income, and free cash flow growth over the past few years, helping them assess the company’s performance trends.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/financial-reports-dates
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/financial-reports-form-10-k-json
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/financial-reports-form-10-k-xlsx
...
Example Use Case A financial analyst can download Apple’s 2022 10-K report in XLSX format, making it easier to import the data into their financial models and analyze trends over the fiscal year.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/revenue-product-segmentation
...
Example Use Case An investor can use the Revenue Product Segmentation API to see how much of Apple’s earnings come from iPhone sales compared to other products, such as Macs or wearables.

Endpoint:

https://financialmodelingprep.com/stable/revenue-product-segmentation?symbol=AAPL

Revenue Product Segmentation API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/revenue-geographic-segments
...
Example Use Case An investor can use the Revenue Geographic Segments API to track Apple’s performance across key regions like the Americas, Europe, and Greater China, helping to identify emerging markets or regions with declining sales.

Endpoint:

https://financialmodelingprep.com/stable/revenue-geographic-segmentation?symbol=AAPL

Revenue Geographic Segments API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/as-reported-income-statements
...
Example Use Case A financial analyst can use the As Reported Income Statements API to access Apple’s quarterly income statements, allowing them to compare operating income and net profit for different fiscal periods without any adjustments.

Endpoint:

https://financialmodelingprep.com/stable/income-statement-as-reported?symbol=AAPL

As Reported Income Statements API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/as-reported-balance-statements
...
Example Use Case An investment analyst can use the As Reported Balance Statements API to evaluate Apple's asset-liability structure for Q1 2010, helping to understand the company's financial position during that period without any adjustments.

Endpoint:

https://financialmodelingprep.com/stable/balance-sheet-statement-as-reported?symbol=AAPL

As Reported Balance Statements API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/as-reported-cashflow-statements
...
Example Use Case A financial analyst can use this API to track Apple's cash flow trends during Q1 2010, helping assess how effectively the company is managing its cash for operations and investments.

Endpoint:

https://financialmodelingprep.com/stable/cash-flow-statement-as-reported?symbol=AAPL

As Reported Cashflow Statements API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/as-reported-financial-statements
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/historical-price-eod-light
...
Example Use Case A financial app can use the Basic Stock Chart API to display a minimal chart showing a stock’s daily closing price and volume, allowing users to quickly assess its performance over time.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/historical-price-eod-full
...
Example Use Case A financial analyst can use the Comprehensive Stock Price and Volume Data API to monitor Apple's daily stock performance, analyzing price changes, VWAP, and trading volume to spot trends and predict future price movements.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/historical-price-eod-non-split-adjusted
...
Example Use Case A market researcher analyzing Apple stock performance before and after a split can use the Unadjusted Stock Price Chart API to get a clear view of stock prices without any split-related adjustments.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/historical-price-eod-dividend-adjusted
...
Example Use Case An investor tracking the historical growth of Apple stock can use the Dividend-Adjusted Price Chart API to account for the effect of dividend payouts when analyzing stock price changes over time.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/intraday-1-min
...
Example Use Case A day trader can use the 1-Minute Interval Stock Chart API to track Apple’s stock price movements throughout the trading day, enabling them to make timely buy and sell decisions based on real-time price changes and volume spikes.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/intraday-5-min
...
Example Use Case A day trader can use the 5-Minute Interval Stock Chart API to monitor Apple's stock throughout the trading day, identifying short-term trends and making timely trading decisions based on price fluctuations.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/intraday-15-min
...
Example Use Case A swing trader can use the 15-Minute Interval Stock Chart API to monitor Apple stock throughout the trading day, analyzing medium-term price movements to make strategic trade entries and exits based on significant fluctuations.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/intraday-30-min
...
Example Use Case A day trader uses the 30-Minute Interval Stock Chart API to monitor the performance of Apple stock over the course of a trading day, identifying important price patterns and volume changes to make calculated buy and sell decisions.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/intraday-1-hour
...
Example Use Case A swing trader uses the 1-Hour Interval Stock Chart API to track the hourly performance of Apple stock throughout the day, helping them make informed buy and sell decisions based on observed trends and trading volume changes.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/intraday-4-hour
...
Example Use Case A position trader uses the 4-Hour Interval Stock Chart API to monitor the longer intraday performance of Apple stock, allowing them to detect more substantial trends and price shifts without getting lost in short-term fluctuations.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/treasury-rates
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/economics-indicators
...
Example Investor Use Case An investor might use the Economic Indicators API to monitor GDP growth rates over the past decade. By analyzing this data, the investor can identify periods of strong economic growth and align their investment strategy accordingly.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/economics-calendar
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/market-risk-premium
...
Analyst Use Case An analyst might use the Market Risk Premium API to calculate the expected return on a stock investment. By subtracting the risk-free rate from the expected market return, they can determine whether the investment offers a sufficient premium to justify the associated risk.
...
Example Use Case A dividend investor can use the Dividends Company API to monitor Apple’s upcoming dividend payment, ensuring they hold the stock through the record date to receive the payment.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/dividends-calendar
...
Example Use Case A portfolio manager can use the Dividend Events Calendar API to keep track of upcoming dividend payments for all stocks in their portfolio, ensuring they don't miss important dividend events or payouts.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/earnings-company
...
Example Use Case A financial analyst can use the Earnings Report API to track Apple's upcoming earnings report, reviewing EPS and revenue estimates to predict how the stock might react after the earnings are announced.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/earnings-calendar
...
Example Trading Strategy: A trader might use the Earnings Calendar API to track the earnings announcements of key technology companies. By knowing the estimated and actual EPS ahead of time, the trader can prepare to make informed trades based on how the market reacts to the earnings results.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/ipos-calendar
...
Example Use Case A venture capitalist can use the IPO Calendar API to track new companies entering the stock market, evaluate pricing expectations, and identify potential investment opportunities.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/ipos-disclosure
...
Example Use Case An institutional investor can use the IPO Disclosures API to track regulatory filings for upcoming IPOs and analyze SEC documents before making investment decisions in new market entrants.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/ipos-prospectus
...
Example Use Case An investment advisor can use the IPO Prospectus API to review a company’s IPO financials and prospectus filings, helping them evaluate whether to recommend the IPO to clients based on the offering's structure.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/splits-company
...
Example Use Case An investor looking to track Apple's stock split history can use the Stock Split Details API to retrieve detailed data on the company's past splits, including the date and ratio, allowing them to assess how splits have impacted stock value over time.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/splits-calendar
...
Example Use Case A portfolio manager can use the Stock Splits Calendar API to stay updated on upcoming stock splits, such as a 1-for-100 split scheduled for GBK.ST on February 29, 2024, to adjust their strategies accordingly.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/latest-transcripts
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/search-transcripts
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/transcripts-dates-by-symbol
...
Example Use Case An investment firm can use the Transcripts Dates By Symbol API to keep track of a company's earnings calls for each quarter and access these transcripts for detailed performance analysis and strategic planning.
...
- Timely Access to Transcript s: Get access to transcripts for upcoming or historical earnings calls for in-depth analysis.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/available-transcript-symbols
- **Endpoint**: `https://financialmodelingprep.com/stable/earnings-transcript-list`
...
Example Use Case A research analyst can use the Available Earnings Transcript Symbols API to compile a list of companies with multiple earnings transcripts, allowing them to focus on companies with the most available historical data for better trend analysis.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/fmp-articles
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/general-news
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/press-releases
...
Example Use Case A financial analyst uses the Press Releases API to monitor corporate announcements from publicly traded companies, providing critical insights for investment decisions.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/stock-news
...
Example Use Case A portfolio manager uses the Stock News API to track real-time updates on the stock markets, ensuring they are aware of any news that may affect the performance of the equities in their portfolio.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/crypto-news
...
Example Use Case A crypto trader uses the Crypto News API to track daily news on Bitcoin and Ethereum, enabling them to stay ahead of market trends.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/forex-news
...
Example Use Case A forex trader uses the Forex News API to track the latest news on currency pairs, helping them make quick and informed trading decisions.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/search-press-releases
...
Example Use Case An investor uses the Search Press Releases API to find the most recent earnings report of a specific company before making an investment decision.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/search-stock-news
...
Example Use Case A trader uses the Search Stock News API to look up recent news articles about a stock they are considering buying, helping them make an informed decision.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/search-crypto-news
...
Example Use Case A crypto investor uses the Search Crypto News API to search for news on Ethereum to understand the recent market movements before making a trade.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/search-forex-news
...
Example Use Case A currency trader uses the Search Forex News API to search for the latest news on EUR/USD, helping them understand recent price fluctuations before entering a trade.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/latest-filings
...
The Institutional Ownership Filings API gives access to the latest SEC filings from institutional investors, providing insights into reports like Form 13F filings. It’s perfect for staying on top of which institutions hold shares in specific companies and monitoring significant ownership changes. This API is ideal for:
...
Example Use Case An investment researcher can use the Institutional Ownership Filings API to monitor changes in institutional ownership for companies like Apple, identifying when major hedge funds or pension funds increase or decrease their stakes.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/filings-extract
...
Example Use Case An investment firm uses the SEC Filings Extract API to track changes in ownership for a specific company by extracting data from quarterly 13F filings. This helps the firm identify trends and adjust its investment strategy accordingly.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/form-13f-filings-dates
...
Example Use Case An analyst can use the Form 13F Filings Dates API to check the filing dates of a major institutional investor, allowing them to compare portfolio changes from quarter to quarter and make informed decisions based on institutional behavior.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/filings-extract-with-analytics-by-holder
...
Example Use Case An investment analyst can use the Filings Extract With Analytics By Holder API to monitor Vanguard Group's activity in Apple Inc. stocks, seeing how much stock Vanguard holds, any changes in weight or market value, and when the stock was first added to their portfolio.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/holder-performance-summary
...
Example Use Case An investment manager can use the Holder Performance Summary API to analyze Berkshire Hathaway's performance over the last five years and compare it to the S&P 500, assessing how well their investment strategy has fared.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/holders-industry-breakdown
...
Example Use Case A financial analyst can use the Holders Industry Breakdown API to analyze Berkshire Hathaway's sector focus, identifying whether they are increasing or decreasing their exposure to industries like technology or healthcare over time.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/positions-summary
...
Example Use Case A hedge fund manager can use the Positions Summary API to track institutional ownership trends in Apple (AAPL), monitoring how many institutions are increasing or reducing their positions, and assessing overall market sentiment.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/industry-summary
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/financial-estimates
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/ratings-snapshot
...
Example Use Case An equity analyst can use the Ratings Snapshot API to compare multiple companies' financial health based on return on equity, debt levels, and valuation ratios, helping them make more informed investment recommendations.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/historical-ratings
...
Example Use Case A portfolio manager can use the Historical Ratings API to analyze how a company’s return on equity and debt-to-equity ratios have evolved over the last five years, helping them evaluate long-term performance trends.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/price-target-summary
...
Example Use Case An investor can use the Price Target Summary API to compare the average price targets for a stock over the past quarter and year to determine if analysts' outlooks have become more bullish or bearish over time.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/price-target-consensus
...
Example Use Case A portfolio manager can use the Price Target Consensus API to assess the potential upside and downside for a stock, using the high, low, median, and consensus price targets to create risk-reward scenarios for investment decisions.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/grades
...
Example Use Case An investor can use the Grades API to track the latest stock ratings for their portfolio, seeing how financial institutions view the company's current performance and investment potential.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/historical-grades
...
Example Use Case A portfolio manager can utilize the Historical Grades API to observe changes in analyst sentiment for a particular stock, helping them adjust their strategy based on evolving market outlooks.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/grades-summary
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/sector-performance-snapshot
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/industry-performance-snapshot
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/historical-sector-performance
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/historical-industry-performance
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/sector-pe-snapshot
...
Example Use Case A portfolio manager uses the Sector P/E Snapshot API to compare the P/E ratios of different sectors on NASDAQ. By seeing that the Basic Materials sector has a P/E ratio of 15.69, they can assess whether this sector is overvalued or undervalued relative to other sectors and adjust their portfolio accordingly.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/industry-pe-snapshot
...
Example Use Case An investor uses the Industry P/E Snapshot API to assess a specific industry on NASDAQ. Knowing the P/E ratio, the investor can determine if the industry is overvalued and adjust their portfolio accordingly.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/historical-sector-pe
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/historical-industry-pe
...
Example Use Case A financial analyst uses the Historical Industry P/E API to review the historical P/E ratios of the Biotechnology industry on NASDAQ. By tracking how the P/E ratio has evolved over time, the analyst can determine whether the industry’s current valuation reflects long-term market trends and decide if it's a good investment opportunity.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/biggest-gainers
...
Example Use Case A trader uses the Top Stock Gainers API to find stocks with the highest price increases on NASDAQ. After identifying CBL International Limited (BANL), which experienced a 27.69% price increase, the trader can decide to take advantage of the momentum and incorporate the stock into their trading strategy.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/biggest-losers
...
Example Use Case A trader uses the Biggest Stock Losers API to identify stocks on NASDAQ experiencing rapid price declines. After spotting a 31.33% drop in iSun, Inc. (ISUN), the trader can assess whether to short the stock or consider it for a rebound play.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/most-active
...
Example Use Case A day trader uses the Top Traded Stocks API to identify which stocks on NASDAQ are experiencing the highest trading volumes. After spotting iSun, Inc. (ISUN) with a significant trading volume, the trader can decide whether to enter a trade based on the stock’s momentum and market interest.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/simple-moving-average
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/exponential-moving-average
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/weighted-moving-average
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/double-exponential-moving-average
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/triple-exponential-moving-average
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/relative-strength-index
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/standard-deviation
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/williams
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/average-directional-index
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/holdings
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/information
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/country-weighting
...
Example Use Case An investor seeking to minimize risk by diversifying internationally might use the ETF & Fund Country Allocation API to identify funds with strong exposure to emerging markets or regions like Asia or Europe.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/etf-asset-exposure
...
Example Use Cases ETF Research: An investor interested in Apple Inc. (AAPL) can use the ETF Asset Exposure API to find all ETFs that hold AAPL shares. The investor can then analyze the weight of AAPL within each ETF to determine which funds are most heavily invested in the stock.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/sector-weighting
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/latest-disclosures
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/mutual-fund-disclosures
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/disclosures-name-search
- **Endpoint**: `https://financialmodelingprep.com/stable/funds/disclosure-holders-search?name=Federated`
...
Example Use Case A financial analyst can use the Mutual Fund & ETF Disclosure Name Search API to retrieve specific disclosures for a mutual fund by entering its name, helping the analyst review relevant regulatory filings and reports for the fund.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/disclosures-dates
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/8k-latest
...
Latest 8-K SEC Filings API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/financials-latest
...
Latest SEC Filings API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/search-by-form-type
...
SEC Filings By Form Type API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/search-by-symbol
...
SEC Filings By Symbol API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/search-by-cik
...
SEC Filings By CIK API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/search-by-name
...
SEC Filings By Name API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/company-search-by-symbol
...
SEC Filings Company Search By Symbol API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/company-search-by-cik
...
SEC Filings Company Search By CIK API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/sec-company-full-profile
...
SEC Company Full Profile API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/industry-classification-list
...
Industry Classification List API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/industry-classification-search
...
Industry Classification Search API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/all-industry-classification
...
All Industry Classification API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/latest-insider-trade
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/search-insider-trades
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/search-reporting-name
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/all-transaction-types
...
Example Use Case A market analyst uses the All Insider Transaction Types API to view a complete list of recent transactions by corporate insiders. By reviewing purchases, sales, and stock options exercised, the analyst can gain insights into corporate sentiment and make better-informed trading decisions.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/insider-trade-statistics
...
Example Use Case A financial analyst uses the Insider Trade Statistics API to examine insider trading trends for Apple (AAPL) in the third quarter of 2024. By reviewing the ratio of shares disposed of to those acquired, along with the total number of sales, the analyst can assess whether insiders are showing confidence in the company’s future.

Endpoint:

https://financialmodelingprep.com/stable/insider-trading/statistics?symbol=AAPL

Insider Trade Statistics API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/acquisition-ownership
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/indexes-list
...
Example Use Case A portfolio manager building a global investment strategy can use the Stock Market Indexes List API to retrieve data on key indexes from exchanges around the world. By identifying relevant indexes in different regions, they can assess market performance and make informed decisions about asset allocation.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/index-quote
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/index-quote-short
...
Example Use Case A trader monitoring the S&P 500 throughout the trading day can use the Stock Index Short Quote API to quickly access real-time price changes, helping them make decisions on whether to buy or sell without delving into more complex data.

Endpoint:

https://financialmodelingprep.com/stable/quote-short?symbol=^VIX

Index Short Quote API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/all-index-quotes
- **Endpoint**: `https://financialmodelingprep.com/stable/batch-index-quotes`
...
Example Use Case A financial analyst tracking global market performance can use the All Index Quotes API to retrieve real-time quotes for multiple stock indexes, such as the S&P 500, FTSE 100, and Nikkei 225, in one request, providing a holistic view of current market trends.

Endpoint:

https://financialmodelingprep.com/stable/batch-index-quotes

All Index Quotes API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/index-historical-price-eod-light
...
Example Use Case An investment analyst is developing a historical trend analysis for the S&P 500 index (^GSPC). By using the Historical Price Data API, they can retrieve end-of-day prices for specific dates, analyze the volume and price movements over time, and present findings to their clients for more informed investment decisions.

Endpoint:

https://financialmodelingprep.com/stable/historical-price-eod/light?symbol=^VIX

Historical Index Light Chart API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/index-historical-price-eod-full
...
Example Use Case A quantitative analyst developing an algorithmic trading model requires complete historical price data for the S&P 500 index (^GSPC). Using the Detailed Historical Price Data API, they can retrieve open, high, low, and close prices, along with VWAP and volume data for each trading day. This detailed information helps refine the model’s predictions and backtesting performance.

Endpoint:

https://financialmodelingprep.com/stable/historical-price-eod/full?symbol=^VIX

Historical Index Full Chart API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/index-intraday-1-min
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/index-intraday-5-min
...
Example Use Case A swing trader monitoring the S&P 500 index (^GSPC) uses the Intraday 5-Minute Price Data API to track price movements over the course of the trading day. By analyzing the 5-minute intervals, they can time their trades more accurately, reacting quickly to short-term market changes and optimizing their strategy for maximum return.

Endpoint:

https://financialmodelingprep.com/stable/historical-chart/5min?symbol=^VIX

5-Minute Interval Index Price API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/index-intraday-1-hour
...
Example Use Case A swing trader using the Intraday 1-Hour Price Data API monitors the S&P 500 index (^GSPC) to observe price movements across several trading hours. With hourly updates, they can identify emerging trends and adjust their positions without the need to track minute-by-minute fluctuations.

Endpoint:

https://financialmodelingprep.com/stable/historical-chart/1hour?symbol=^VIX

1-Hour Interval Index Price API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/sp-500
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/nasdaq
...
Example Use Case A financial analyst monitoring the technology sector uses the Nasdaq Index API to track the real-time performance of Nasdaq-listed companies, such as Apple Inc. (AAPL). By retrieving sector-specific data, the analyst can make informed decisions on market trends and identify potential investment opportunities in the tech industry.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/dow-jones
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/historical-sp-500
...
Example Use Case A financial researcher uses the Historical S&P 500 API to study how the composition of the index has changed over the last decade. By analyzing additions and removals, such as the recent inclusion of Dell Technologies (DELL) in place of Etsy (ETSY), they can assess how shifts in market capitalization and industry representation affect overall index performance.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/historical-nasdaq
...
Example Use Case A market analyst uses the Historical Nasdaq API to study changes in the composition of the Nasdaq index over the last five years. By examining data like the inclusion of Arm Holdings (ARM) and the removal of Sirius XM (SIRI) in 2024, they can assess how industry shifts and market dynamics have influenced the index’s overall performance.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/historical-dow-jones
...
Example Use Case A market researcher uses the Historical Dow Jones API to study how the index has evolved over the past decade. By examining changes like the inclusion of Amazon (AMZN) and the removal of Walgreens Boots Alliance (WBA) in 2024, the researcher can better understand how shifts in market capitalization and industry performance have influenced the Dow Jones over time.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/exchange-market-hours
...
Global Exchange Market Hours API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/holidays-by-exchange
...
Holidays By Exchange API Parameters


### 403 ERROR

- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/all-exchange-market-hours
...
All Exchange Market Hours API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/commodities-list
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/commodities-quote
...
Commodities Quote API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/commodities-quote-short
...
Commodities Quote Short API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/all-commodities-quotes
- **Endpoint**: `https://financialmodelingprep.com/stable/batch-commodity-quotes`
...
All Commodities Quotes API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/commodities-historical-price-eod-light
- **Endpoint**: `https://financialmodelingprep.com/stable/historical-price-eod/light?symbol=^GSPC`
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/commodities-historical-price-eod-full
- **Endpoint**: `https://financialmodelingprep.com/stable/historical-price-eod/full?symbol=^GSPC`
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/commodities-intraday-1-min
...
1-Minute Interval Commodities Chart API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/commodities-intraday-5-min
...
5-Minute Interval Commodities Chart API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/commodities-intraday-1-hour
...
1-Hour Interval Commodities Chart API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/dcf-advanced
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/dcf-levered
...
Example Use Case An investor evaluating whether to buy Apple shares can use the Levered DCF API to compare the company's DCF value to its current stock price. If the DCF is significantly lower than the market price, the investor might reconsider the purchase, factoring in the company’s debt obligations.

Endpoint:

https://financialmodelingprep.com/stable/levered-discounted-cash-flow?symbol=AAPL

Levered DCF API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/custom-dcf-advanced
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/custom-dcf-levered
...
Custom DCF Levered API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/forex-list
...
Example Forex Trading Strategy: A forex trader might use the Forex Currency Pairs API to identify high-volume currency pairs such as EUR/USD or GBP/JPY. By tracking the performance of these pairs over time, the trader can develop strategies to capitalize on market movements.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/forex-quote
- **Endpoint**: `https://financialmodelingprep.com/stable/batch-forex-quotes`
...
Example Use Case A forex trader uses the Fx Quotes API to monitor the EUR/USD exchange rate throughout the day. By tracking live price changes and percentage movements, the trader can time their trades and react quickly to market fluctuations.

Endpoint:

https://financialmodelingprep.com/stable/quote?symbol=EURUSD

Forex Quote API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/forex-quote-short
...
Example Use Case A currency trader uses the Forex Quote Snapshot API to monitor the EUR/USD pair throughout the day, quickly checking price changes and volume to make rapid trading decisions.

Endpoint:

https://financialmodelingprep.com/stable/quote-short?symbol=EURUSD

Forex Short Quote API Parameters


**Caratteristiche:**
- Real-Time Price Data : Instantly retrieve the current price for forex pairs such as EUR/USD. Brief Overview: Access essential data, including the latest price change and trading volume, in a compact format.
- Efficient Monitoring : Ideal for traders and analysts who need fast updates without extensive details.


### 403 ERROR

- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/all-forex-quotes
- **Endpoint**: `https://financialmodelingprep.com/stable/batch-forex-quotes`
...
Example Use Case A forex trader uses the Batch Forex Quotes API to retrieve quotes for 50 different currency pairs at once, helping them monitor price movements and volume across global currencies in real time.

Endpoint:

https://financialmodelingprep.com/stable/batch-forex-quotes

Batch Forex Quotes API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/forex-historical-price-eod-light
...
Example Use Case A forex trader uses the Historical Forex Light Chart API to review end-of-day prices for the EUR/USD currency pair over the past five years. By analyzing this data, the trader identifies key support and resistance levels, helping refine their trading strategy.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/forex-historical-price-eod-full
...
Example Use Case A portfolio manager uses the Full Historical Forex Chart API to analyze the EUR/USD pair's daily open, high, low, and close prices over the last decade. By reviewing these trends, the manager develops a more informed strategy for managing currency exposure.

Endpoint:

https://financialmodelingprep.com/stable/historical-price-eod/full?symbol=EURUSD

Historical Forex Full Chart API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/forex-intraday-1-min
...
Example Use Case A day trader uses the 1-Minute Forex Interval Chart API to track price movements in the EUR/USD currency pair. By monitoring each minute’s open, high, low, and close prices, the trader executes a scalping strategy and optimizes profit opportunities within a single trading session.

Endpoint:

https://financialmodelingprep.com/stable/historical-chart/1min?symbol=EURUSD

1-Minute Interval Forex Chart API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/forex-intraday-5-min
...
Example Use Case A forex trader monitoring the EUR/USD pair uses the 5-Minute Forex Interval Chart API to analyze price fluctuations during volatile periods. By tracking 5-minute intervals, the trader makes informed decisions on when to enter or exit trades.

Endpoint:

https://financialmodelingprep.com/stable/historical-chart/5min?symbol=EURUSD

5-Minute Interval Forex Chart API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/forex-intraday-1-hour
...
Example Use Case A forex analyst looking to optimize their swing trading strategy uses the 1-Hour Forex Interval Chart API to track price movements of the USD/JPY pair. By monitoring hourly changes, the analyst identifies price consolidation points and adjusts their trades accordingly.

Endpoint:

https://financialmodelingprep.com/stable/historical-chart/1hour?symbol=EURUSD

1-Hour Interval Forex Chart API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/cryptocurrency-list
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/cryptocurrency-quote
...
Full Cryptocurrency Quote API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/cryptocurrency-quote-short
...
Example Use Case A day trader can use the Cryptocurrency Quick Quote API to track the price of Bitcoin and monitor real-time changes in price and volume, helping them make quick trading decisions in volatile markets.

Endpoint:

https://financialmodelingprep.com/stable/quote-short?symbol=BTCUSD

Cryptocurrency Quote Short API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/all-cryptocurrency-quotes
- **Endpoint**: `https://financialmodelingprep.com/stable/batch-crypto-quotes`
...
Example Use Case A portfolio manager can use the Real-Time Cryptocurrency Batch Quotes API to monitor the prices and market activity of multiple cryptocurrencies in real-time, allowing them to make quick and informed decisions across their digital asset portfolio.

Endpoint:

https://financialmodelingprep.com/stable/batch-crypto-quotes

All Cryptocurrencies Quotes API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/cryptocurrency-historical-price-eod-light
...
Example Use Case An analyst can use the Historical Cryptocurrency Price Snapshot API to backtest trading strategies by reviewing past price movements and identifying patterns that could influence future price action.

Endpoint:

https://financialmodelingprep.com/stable/historical-price-eod/light?symbol=BTCUSD

Historical Cryptocurrency Light Chart API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/cryptocurrency-historical-price-eod-full
...
Example Use Case A long-term cryptocurrency investor could use the Full Historical Cryptocurrency Data API to analyze Bitcoin’s market performance over the past year, identifying key resistance levels and potential buying opportunities based on historical price trends.

Endpoint:

https://financialmodelingprep.com/stable/historical-price-eod/full?symbol=BTCUSD

Historical Cryptocurrency Full Chart API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/cryptocurrency-intraday-1-min
...
Example Use Case A day trader can use the 1-Minute Cryptocurrency Intraday Data API to monitor real-time price movements and volume spikes, making quick decisions based on emerging market trends or breakouts.

Endpoint:

https://financialmodelingprep.com/stable/historical-chart/1min?symbol=BTCUSD

1-Minute Interval Cryptocurrency Data API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/cryptocurrency-intraday-5-min
...
Example Use Case A day trader uses the 5-Minute Interval Cryptocurrency Data API to track Bitcoin's price movements throughout the day. By analyzing the short-term price trends, the trader identifies optimal entry and exit points for their trades.

Endpoint:

https://financialmodelingprep.com/stable/historical-chart/5min?symbol=BTCUSD

5-Minute Interval Cryptocurrency Data API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/cryptocurrency-intraday-1-hour
...
Example Use Case A swing trader uses the 1-Hour Interval Cryptocurrency Data API to monitor the price of Ethereum. By analyzing hourly trends, the trader can spot potential breakouts or pullbacks and adjust their positions accordingly.

Endpoint:

https://financialmodelingprep.com/stable/historical-chart/1hour?symbol=BTCUSD

1-Hour Interval Cryptocurrency Data API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/senate-latest
...
Latest Senate Financial Disclosures API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/house-latest
...
Latest House Financial Disclosures API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/senate-trading
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/senate-trading-by-name
...
senate-trading-by-name API Parameters


### 403 ERROR

- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/house-trading
...
U.S. House Trades API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/house-trading-by-name
...
house-trading-by-name API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/esg-search
...
ESG Investment Search API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/esg-ratings
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/esg-benchmark
...
ESG Benchmark Comparison API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/cot-report
...
Example Use Case A commodity trader can use the COT Report API to analyze the open interest and trader positions in the cocoa market, identifying trends in long and short positions to refine their trading strategy.

Endpoint:

https://financialmodelingprep.com/stable/commitment-of-traders-report

COT Report API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/cot-report-analysis
...
Example Use Case A commodity trader can use the COT Report Analysis API to assess the bullish sentiment in the energy market by tracking changes in the net position of Brent crude oil traders, allowing them to refine their trading strategy accordingly.

Endpoint:

https://financialmodelingprep.com/stable/commitment-of-traders-analysis

COT Analysis By Dates API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/cot-report-list
...
Example Use Case A trader looking to assess market sentiment in the natural gas market can use the COT Report List API to identify the relevant futures contract and pull detailed sentiment data from the associated COT report.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/latest-crowdfunding
...
Example Use Case An investor can use the Crowdfunding Campaigns API to review the financial health and offering details of various crowdfunding campaigns, helping them evaluate potential opportunities and diversify their portfolio.

Endpoint:

https://financialmodelingprep.com/stable/crowdfunding-offerings-latest?page=0&limit=100

Latest Crowdfunding Campaigns API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/crowdfunding-search
...
Crowdfunding Campaign Search API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/crowdfunding-by-cik
...
Crowdfunding By CIK API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/latest-equity-offering
...
Example Use Case An institutional investor could use the Equity Offering Updates API to identify new investment opportunities by tracking newly issued equity offerings from companies across various sectors.

Endpoint:

https://financialmodelingprep.com/stable/fundraising-latest?page=0&limit=10

Equity Offering Updates API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/equity-offering-search
...
Example Use Case An investor can use the Equity Offering Search API to identify which companies are issuing new shares, allowing them to assess the impact of equity offerings on their portfolio or potential investments.

Endpoint:

https://financialmodelingprep.com/stable/fundraising-search?name=NJOY

Equity Offering Search API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/equity-offering-by-cik
...
Equity Offering By CIK API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/profile-bulk
...
Company Profile Bulk API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/rating-bulk
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/dcf-bulk
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/scores-bulk
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/price-target-summary-bulk
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/etf-holder-bulk
...
ETF Holder Bulk API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/upgrades-downgrades-consensus-bulk
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/key-metrics-ttm-bulk
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/ratios-ttm-bulk
...
- Valuation Ratio s: Ratios such as price-to-earnings (P/E), price-to-book (P/B), and price-to-sales (P/S) to help investors determine whether a stock is overvalued or undervalued.
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/peers-bulk
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/earnings-surprises-bulk
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/income-statement-bulk
...
Income Statement Bulk API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/income-statement-growth-bulk
...
Income Statement Growth Bulk API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/balance-sheet-statement-bulk
...
Balance Sheet Statement Bulk API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/balance-sheet-statement-growth-bulk
...
Balance Sheet Statement Growth Bulk API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/cash-flow-statement-bulk
...
Cash Flow Statement Bulk API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/cash-flow-statement-growth-bulk
...
Cash Flow Statement Growth Bulk API Parameters
...
- **URL doc**: https://site.financialmodelingprep.com/developer/docs/stable/eod-bulk
