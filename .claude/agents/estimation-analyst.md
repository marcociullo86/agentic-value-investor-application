...
I tool vivono in `.claude/tools/analytics/*` come script Bash/Python/TS (no MCP): `run-pert.sh`,
...
- Implementare le formule di stima (vivono nei tool deterministici `.claude/tools/analytics/*`).
